...
export function Hero() {
    ...
    <Link className='inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-green-600' href="/memories/new">Register memory</Link>
  </div>
  )}